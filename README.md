...
# AWESOME DATA SCIENCE with stars

[![Awesome](https://cdn.jsdelivr.net/gh/sindresorhus/awesome@d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 509,634 | 🐛 106 | 📅 2026-09-02
...
| Link                                                                                                                                            | Preview                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| ----------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Data Science For Beginners](https://github.com/microsoft/Data-Science-For-Beginners) ⭐ 37,266 \| 🐛 20 \| 🌐 Jupyter Notebook \| 📅 2026-09-13 | Microsoft are pleased to offer a 10-week, 20-lesson curriculum all about Data Science.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
* [ADK-Rust](https://github.com/zavora-ai/adk-rust) ⭐ 682 | 🐛 15 | 🌐 Rust | 📅 2026-09-20 - Production-ready AI agent development kit for Rust with model-agnostic design (Gemini, OpenAI, Anthropic), multiple agent types (LLM, Graph, Workflow), MCP support, and built-in telemetry.
* [Lumen](https://github.com/holoviz/lumen) ⭐ 313 | 🐛 179 | 🌐 Python | 📅 2026-09-21 - Agent framework for chatting with data, turning natural language into SQL, transformation pipelines and visualizations. Outputs are declarative specs that can be inspected, edited, reopened in a notebook or composed into a dashboard.

### Tools

* [Kitaru](https://github.com/zenml-io/kitaru) ⭐ 293 | 🐛 39 | 🌐 Python | 📅 2026-09-24 - Open-source platform that records real AI agent runs, replays them against changes, and evaluates outcomes before deployment.
* [ai-evaluation](https://github.com/future-agi/ai-evaluation) ⭐ 121 | 🐛 20 | 🌐 Python | 📅 2026-09-24 - Open-source LLM and agent evaluation framework with 50+ metrics, LLM-as-Judge augmentation, and guardrail scanners (jailbreak, PII, prompt-injection). Useful for scoring RAG outputs, agent trajectories, and function-calling behavior in data-science workflows.
* [DeepAlpha](https://github.com/stefanoviana/deepalpha) ⭐ 46 | 🐛 17 | 🌐 Python | 📅 2026-05-12 - AI crypto trading framework using LightGBM + XGBoost ensemble with 72 ML features. 70.9% walk-forward validated accuracy on out-of-sample data. Supports Bybit and Binance. MIT licensed, available on [PyPI](https://pypi.org/project/deepalpha-bot/).
* [CAJAL](https://github.com/Agnuxo1/CAJAL) ⭐ 21 | 🐛 0 | 🌐 Python | 📅 2026-09-21 - Local AI agent for generating publication-ready scientific papers with real arXiv citations, IMRaD structure, and tribunal scoring. Runs 100% offline via Ollama with 4B-9B models. MIT licensed. [HuggingFace](https://huggingface.co/Agnuxo/CAJAL-9B-P2PCLAW)
* [Not Human Search](https://nothumansearch.ai) - Search engine for AI agents that indexes 9,000+ AI tools and APIs, scoring each on agentic readiness (llms.txt, OpenAPI, MCP, ai-plugin.json). REST API and MCP server for programmatic tool discovery. [GitHub](https://github.com/unitedideas/nothumansearch) ⭐ 8 | 🐛 1 | 🌐 Go | 📅 2026-08-25
* [Arch Tools](https://archtools.dev) - 61 production-ready AI API tools for data science workflows: code analysis, web scraping, NLP, image generation, crypto data, and search. REST API and MCP protocol support. [GitHub](https://github.com/Deesmo/Arch-AI-Tools) ⭐ 1 | 🐛 29 | 🌐 HTML | 📅 2026-09-21
...
* [II-Commons](https://github.com/Intelligent-Internet/II-Commons-Skills) ⭐ 16 | 🐛 1 | 🌐 JavaScript | 📅 2026-07-08 - Daily-updated skill and CLI for deterministic retrieval across arXiv, PubMed/PMC, and supported US policy corpora.

* [Chunk Tuner](https://github.com/shantanu-deshmukh/chunktuner) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2026-06-21 - Open-source Python library and MCP server to benchmark document chunking strategies for RAG, score retrieval quality, and recommend configurations for a corpus.
...
* [Minimum Viable Study Plan for Machine Learning Interviews](https://github.com/khangich/machine-learning-interview) ⭐ 12,821 | 🐛 11 | 📅 2023-08-31
* [Train LLM From Scratch](https://github.com/FareedKhan-dev/train-llm-from-scratch) ⭐ 10,904 | 🐛 7 | 🌐 Python | 📅 2026-08-17 - A straightforward method for training your LLM, from downloading data to generating text.
* [#tidytuesday](https://github.com/rfordatascience/tidytuesday) ⭐ 8,407 | 🐛 209 | 🌐 HTML | 📅 2026-09-21 - A weekly data project aimed at the R ecosystem.
* [Tutorials of source code from the book Genetic Algorithms with Python by Clinton Sheppard](https://github.com/handcraftsman/GeneticAlgorithmsWithPython) ⭐ 1,260 | 🐛 3 | 🌐 Python | 📅 2022-10-17
* [PySpark Cheatsheet](https://github.com/kevinschaich/pyspark-cheatsheet) ⭐ 701 | 🐛 3 | 📅 2023-02-21
* [Data science your way](https://github.com/jadianes/data-science-your-way) ⭐ 619 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2021-04-25
* [Tutorials to get started on signal processing for machine learning](https://github.com/jinglescode/python-signal-processing) ⭐ 85 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2022-09-16
...
* [AI Expert Roadmap](https://github.com/AMAI-GmbH/AI-Expert-Roadmap) ⭐ 31,261 | 🐛 19 | 🌐 JavaScript | 📅 2025-09-12 - Roadmap to becoming an Artificial Intelligence Expert
* [Data Science](https://github.com/ossu/data-science) ⭐ 21,979 | 🐛 4 | 📅 2025-05-13 - Open Source Society University
* [Hands-on Train and Deploy ML](https://github.com/Paulescu/hands-on-train-and-deploy-ml) ⭐ 890 | 🐛 6 | 🌐 Python | 📅 2024-05-29 - A hands-on course to train and deploy a serverless API that predicts crypto prices.
...
* [Data Science Specialization](https://github.com/DataScienceSpecialization/courses) ⭐ 4,156 | 🐛 87 | 🌐 HTML | 📅 2021-03-30
...
* [A list of colleges and universities offering degrees in data science.](https://github.com/ryanswanstrom/awesome-datascience-colleges) ⭐ 160 | 🐛 0 | 🌐 Python | 📅 2021-01-24
...
* [datacompy](https://github.com/capitalone/datacompy) ⭐ 659 | 🐛 8 | 🌐 Python | 📅 2026-09-23 - DataComPy is a package to compare two Pandas DataFrames.
...
* [JAX](https://github.com/google/jax) ⭐ 36,331 | 🐛 2,594 | 🌐 Python | 📅 2026-09-24
* [XGBoost](https://github.com/dmlc/xgboost) ⭐ 28,790 | 🐛 431 | 🌐 C++ | 📅 2026-09-23
* [LightGBM](https://github.com/microsoft/LightGBM) ⭐ 18,808 | 🐛 521 | 🌐 C++ | 📅 2026-09-24
* [dlib](https://github.com/davisking/dlib) ⭐ 14,445 | 🐛 39 | 🌐 C++ | 📅 2026-09-23
* [CatBoost](https://github.com/catboost/catboost) ⭐ 9,115 | 🐛 724 | 🌐 C++ | 📅 2026-09-24
* [scikit-opt](https://github.com/guofei9987/scikit-opt) ⭐ 6,717 | 🐛 71 | 🌐 Python | 📅 2026-03-25
* [scikit-image](https://github.com/scikit-image/scikit-image) ⭐ 6,595 | 🐛 952 | 🌐 Python | 📅 2026-09-23
* [causalml](https://github.com/uber/causalml) ⭐ 6,006 | 🐛 21 | 🌐 Python | 📅 2026-08-20
* [mlpack](https://github.com/mlpack/mlpack) ⭐ 5,710 | 🐛 14 | 🌐 C++ | 📅 2026-09-17
* [cuML](https://github.com/rapidsai/cuml) ⭐ 5,288 | 🐛 808 | 🌐 Python | 📅 2026-09-24
* [MLxtend](https://github.com/rasbt/mlxtend) ⭐ 5,176 | 🐛 141 | 🌐 Python | 📅 2026-09-18
* [Deepchecks](https://github.com/deepchecks/deepchecks) ⭐ 4,056 | 🐛 267 | 🌐 Python | 📅 2025-12-28
* [xLearn](https://github.com/aksnzhy/xlearn) ⭐ 3,089 | 🐛 194 | 🌐 C++ | 📅 2023-08-28
* [hyperlearn](https://github.com/danielhanchen/hyperlearn) ⭐ 2,518 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2024-11-19
* [modAL](https://github.com/modAL-python/modAL) ⭐ 2,366 | 🐛 108 | 🌐 Python | 📅 2024-02-26
* [imodels](https://github.com/csinva/imodels) ⭐ 1,620 | 🐛 9 | 🌐 Jupyter Notebook | 📅 2026-09-23
* [scikit-feature](https://github.com/jundongl/scikit-feature) ⭐ 1,586 | 🐛 46 | 🌐 Python | 📅 2024-07-11
* [Sparkit-learn](https://github.com/lensacom/sparkit-learn) ⭐ 1,150 | 🐛 35 | 🌐 Python | 📅 2020-12-31
* [pyGAM](https://github.com/dswah/pyGAM) ⭐ 1,016 | 🐛 237 | 🌐 Python | 📅 2026-04-21
* [scikit-multilearn](https://github.com/scikit-multilearn/scikit-multilearn) ⭐ 954 | 🐛 92 | 🌐 Python | 📅 2024-02-01
* [sklearn-deap](https://github.com/rsteca/sklearn-deap) ⭐ 771 | 🐛 28 | 🌐 Jupyter Notebook | 📅 2024-02-10
* [PerpetualBooster](https://github.com/perpetual-ml/perpetual) ⭐ 708 | 🐛 3 | 🌐 Rust | 📅 2026-04-02
* [seqlearn](https://github.com/larsmans/seqlearn) ⭐ 706 | 🐛 33 | 🌐 Python | 📅 2023-03-24
* [pystruct](https://github.com/pystruct/pystruct) ⭐ 667 | 🐛 108 | 🌐 Python | 📅 2021-09-23
* [sklearn-bayes](https://github.com/AmazaspShumik/sklearn-bayes) ⭐ 520 | 🐛 20 | 🌐 Jupyter Notebook | 📅 2021-09-22
* [sklearn-expertsys](https://github.com/tmadl/sklearn-expertsys) ⭐ 491 | 🐛 5 | 🌐 Python | 📅 2017-08-11
* [RuleFit](https://github.com/christophM/rulefit) ⭐ 443 | 🐛 29 | 🌐 Python | 📅 2023-10-08
* [sklearn-crfsuite](https://github.com/TeamHG-Memex/sklearn-crfsuite) ⭐ 440 | 🐛 41 | 🌐 Python | 📅 2026-04-08
* [scikit-rebate](https://github.com/EpistasisLab/scikit-rebate) ⭐ 421 | 🐛 18 | 🌐 Jupyter Notebook | 📅 2026-09-12
* [scikit-posthocs](https://github.com/maximtrp/scikit-posthocs) ⭐ 388 | 🐛 1 | 🌐 Python | 📅 2026-09-19
* [sigopt\_sklearn](https://github.com/sigopt/sigopt-sklearn) ⚠️ Archived
...
* [PhilanthroPy](https://github.com/PhilanthroPy-Project/PhilanthroPy) ⭐ 11 | 🐛 11 | 🌐 Python | 📅 2026-09-23 - Scikit-learn native toolkit for nonprofit fundraising analytics: leakage-safe donor propensity, lapse, planned-giving, wealth-screening and revenue-forecasting estimators.
* [sklearn-evaluation](https://github.com/edublancas/sklearn-evaluation) ⭐ 3 | 🐛 0 | 📅 2023-01-15
* [me\_fasttext](https://github.com/initial-d/me_fasttext) ⭐ 1 | 🐛 2 | 🌐 C++ | 📅 2026-09-24 - Memory-efficient FastText variant with exact trie n-gram IDs, structure-aware row sharing, and mmap serving for large-vocabulary NLP.
...
* [PyTorch](https://github.com/pytorch/pytorch) ⭐ 103,234 | 🐛 17,575 | 🌐 Python | 📅 2026-09-24
* [Yolov8](https://github.com/ultralytics/ultralytics) ⭐ 61,982 | 🐛 72 | 🌐 Python | 📅 2026-09-24
* [Yolov5](https://github.com/ultralytics/yolov5) ⭐ 58,076 | 🐛 31 | 🌐 Python | 📅 2026-09-16
* [pytorch\_geometric](https://github.com/pyg-team/pytorch_geometric) ⭐ 24,097 | 🐛 1,346 | 🌐 Python | 📅 2026-09-01
* [torchvision](https://github.com/pytorch/vision) ⭐ 17,926 | 🐛 1,225 | 🌐 Python | 📅 2026-09-23
* [Yolov3](https://github.com/ultralytics/yolov3) ⭐ 10,610 | 🐛 4 | 🌐 Python | 📅 2026-09-10
* [pyro](https://github.com/pyro-ppl/pyro) ⭐ 9,059 | 🐛 293 | 🌐 Python | 📅 2026-09-07
* [skorch](https://github.com/skorch-dev/skorch) ⭐ 6,179 | 🐛 65 | 🌐 Jupyter Notebook | 📅 2026-09-22
* [ignite](https://github.com/pytorch/ignite) ⭐ 4,787 | 🐛 186 | 🌐 Python | 📅 2026-09-09
* [GPyTorch](https://github.com/cornellius-gp/gpytorch) ⭐ 3,917 | 🐛 424 | 🌐 Python | 📅 2026-07-10
* [torchtext](https://github.com/pytorch/text) ⚠️ Archived
* [Catalyst](https://github.com/catalyst-team/catalyst) ⭐ 3,385 | 🐛 5 | 🌐 Python | 📅 2026-07-08
* [torchaudio](https://github.com/pytorch/audio) ⭐ 2,944 | 🐛 340 | 🌐 Python | 📅 2026-09-23
* [PyTorchNet](https://github.com/pytorch/tnt) ⭐ 1,723 | 🐛 94 | 🌐 Python | 📅 2026-09-11
* [pytorch\_tabular](https://github.com/manujosephv/pytorch_tabular) ⭐ 1,686 | 🐛 33 | 🌐 Python | 📅 2026-09-21
* [PyToune](https://github.com/GRAAL-Research/poutyne) ⭐ 578 | 🐛 9 | 🌐 Python | 📅 2026-06-07
* [PyVarInf](https://github.com/ctallec/pyvarinf) ⭐ 362 | 🐛 4 | 🌐 Python | 📅 2019-10-12
* [TorchDR](https://github.com/TorchDR/TorchDR) ⭐ 216 | 🐛 17 | 🌐 Python | 📅 2026-09-17 - GPU and multi-GPU dimensionality reduction with a scikit-learn-compatible API.
* [OpenLanguageModel](https://github.com/openlanguagemodel/openlanguagemodel) ⭐ 24 | 🐛 17 | 🌐 Python | 📅 2026-08-16 - PyTorch-native library for building, training and teaching transformer language models, with architectures written as ordinary nn.Modules.

#### TensorFlow Ecosystem

* [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 200,273 | 🐛 3,348 | 🌐 C++ | 📅 2026-09-24
* [Ludwig](https://github.com/ludwig-ai/ludwig) ⭐ 11,764 | 🐛 1 | 🌐 Python | 📅 2026-09-21
* [Sonnet](https://github.com/deepmind/sonnet) ⭐ 9,970 | 🐛 44 | 🌐 Python | 📅 2026-07-07
* [TFLearn](https://github.com/tflearn/tflearn) ⭐ 9,573 | 🐛 579 | 🌐 Python | 📅 2024-05-06
* [TensorLayer](https://github.com/tensorlayer/TensorLayer) ⭐ 7,381 | 🐛 36 | 🌐 Python | 📅 2023-02-18
* [tensorpack](https://github.com/tensorpack/tensorpack) ⭐ 6,284 | 🐛 14 | 🌐 Python | 📅 2023-08-06
* [Polyaxon](https://github.com/polyaxon/polyaxon) ⭐ 3,735 | 🐛 125 | 🌐 MDX | 📅 2026-09-23
* [TensorForce](https://github.com/tensorforce/tensorforce) ⭐ 3,305 | 🐛 47 | 🌐 Python | 📅 2026-09-02
* [TRFL](https://github.com/deepmind/trfl) ⭐ 3,130 | 🐛 6 | 🌐 Python | 📅 2022-12-08
* [TF-Agents](https://github.com/tensorflow/agents) ⭐ 3,027 | 🐛 212 | 🌐 Python | 📅 2026-01-16
* [TensorFlow Fold](https://github.com/tensorflow/fold) ⚠️ Archived
* [Mesh TensorFlow](https://github.com/tensorflow/mesh) ⚠️ Archived
* [NeuPy](https://github.com/itdxer/neupy) ⭐ 735 | 🐛 39 | 🌐 Python | 📅 2024-11-18
* [tensorflow-upstream](https://github.com/ROCmSoftwarePlatform/tensorflow-upstream) ⭐ 706 | 🐛 95 | 🌐 C++ | 📅 2026-09-23
* [tfdeploy](https://github.com/riga/tfdeploy) ⭐ 353 | 🐛 12 | 🌐 Python | 📅 2025-01-04
* [tensorlm](https://github.com/batzner/tensorlm) ⭐ 60 | 🐛 2 | 🌐 Python | 📅 2022-06-21
* [TensorLight](https://github.com/bsautermeister/tensorlight) ⭐ 11 | 🐛 1 | 🌐 Python | 📅 2022-10-06

#### Keras Ecosystem

* [keras-rl](https://github.com/keras-rl/keras-rl) ⭐ 5,548 | 🐛 47 | 🌐 Python | 📅 2023-09-17
* [Spektral](https://github.com/danielegrattarola/spektral) ⭐ 2,396 | 🐛 74 | 🌐 Python | 📅 2024-01-21
* [Hyperas](https://github.com/maxpumperla/hyperas) ⭐ 2,173 | 🐛 97 | 🌐 Python | 📅 2023-01-05
* [Talos](https://github.com/autonomio/talos) ⭐ 1,636 | 🐛 13 | 🌐 Python | 📅 2024-04-22
* [keras-contrib](https://github.com/keras-team/keras-contrib) ⚠️ Archived
* [Elephas](https://github.com/maxpumperla/elephas) ⭐ 1,574 | 🐛 11 | 🌐 Python | 📅 2023-05-01
* [qkeras](https://github.com/google/qkeras) ⭐ 584 | 🐛 49 | 🌐 Python | 📅 2026-02-23
* [Hera](https://github.com/keplr-io/hera) ⭐ 486 | 🐛 5 | 🌐 JavaScript | 📅 2017-05-24
...
* [Netron](https://github.com/lutzroeder/netron) ⭐ 33,521 | 🐛 19 | 🌐 JavaScript | 📅 2026-09-24
* [TensorWatch](https://github.com/microsoft/tensorwatch) ⭐ 3,471 | 🐛 54 | 🌐 Jupyter Notebook | 📅 2026-03-30
* [vizzu](https://github.com/vizzuhq/vizzu-lib) ⭐ 2,036 | 🐛 3 | 🌐 JavaScript | 📅 2026-04-20
* [torchvista](https://github.com/sachinhosmani/torchvista) ⭐ 767 | 🐛 11 | 🌐 Python | 📅 2026-09-05 - Interactive notebook-based tool to visualize the forward pass of any PyTorch model.
* [FlexViz](https://github.com/flex-analytics/flexviz) ⭐ 40 | 🐛 32 | 🌐 Python | 📅 2026-09-24 - Python library for interactive, cross-filtered dashboards that stay responsive on 100M+ rows by aggregating with Polars on the server.
* [Resseract Lite](https://github.com/abistarun/resseract-lite) ⭐ 7 | 🐛 6 | 🌐 Java | 📅 2024-08-24
...
| Link                                                                                                                                            | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| ----------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [The Data Science Lifecycle Process](https://github.com/dslp/dslp) ⭐ 529 \| 🐛 6 \| 📅 2021-05-04                                               | The Data Science Lifecycle Process is a process for taking data science teams from Idea to Value repeatedly and sustainably. The process is documented in this repo                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| [Data Science Lifecycle Template Repo](https://github.com/dslp/dslp-repo-template) ⭐ 205 \| 🐛 0 \| 🌐 Python \| 📅 2020-07-02                  | Template repository for data science lifecycle project                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| [TabGAN](https://github.com/Diyago/Tabular-data-generation) ⭐ 570 \| 🐛 0 \| 🌐 Python \| 📅 2026-03-29                                         | Synthetic tabular data generation using GANs, Diffusion Models, and LLMs with adversarial filtering and privacy metrics.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
| [FileShot.io](https://github.com/FileShot/FileShotZKE) ⭐ 31 \| 🐛 1 \| 🌐 HTML \| 📅 2026-06-03                                                 | Secure zero-knowledge encrypted file sharing (AES-256-GCM in-browser). No account required, MIT licensed, self-hostable, optional link expiry.                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
| [PyTorch Geometric Temporal](https://github.com/benedekrozemberczki/pytorch_geometric_temporal) ⭐ 2,990 \| 🐛 30 \| 🌐 Python \| 📅 2026-05-30  | Representation learning on dynamic graphs.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| [Little Ball of Fur](https://github.com/benedekrozemberczki/littleballoffur) ⭐ 715 \| 🐛 7 \| 🌐 Python \| 📅 2025-12-20                        | A graph sampling library for NetworkX with a Scikit-Learn like API.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| [steppy](https://github.com/minerva-ml/steppy) ⚠️ Archived                                                                                      | Lightweight, Python library for fast and reproducible machine learning experimentation. Introduces very simple interface that enables clean machine learning pipeline design.                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| [steppy-toolkit](https://github.com/minerva-ml/steppy-toolkit) ⚠️ Archived                                                                      | Curated collection of the neural networks, transformers and models that make your machine learning work faster and more effective.                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| [Pandas GUI](https://github.com/adrotog/PandasGUI) ⭐ 3,256 \| 🐛 82 \| 🌐 Python \| 📅 2025-05-30                                               | Pandas GUI                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| [NuriStat](https://github.com/baramgay/stat) ⭐ 2 \| 🐛 1 \| 🌐 Python \| 📅 2026-07-09                                                          | Free open-source SPSS alternative — menu-driven desktop statistics (t-tests, ANOVA, regression, survival analysis, ROC) with SPSS .sav import/export                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| [Polars](https://github.com/pola-rs/polars) ⭐ 39,851 \| 🐛 2,932 \| 🌐 Rust \| 📅 2026-09-24                                                    | Fast DataFrame library for Rust and Python, designed as a faster alternative to Pandas                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| [Nervana's python based Deep Learning Framework](https://github.com/NervanaSystems/neon) ⚠️ Archived                                            | Intel® Nervana™ reference deep learning framework committed to best performance on all hardware.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| [Skale](https://github.com/skale-me/skale) ⚠️ Archived                                                                                          | High performance distributed data processing in NodeJS                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| [Aerosolve](https://airbnb.io/aerosolve/)                                                                                                       | A machine learning package built for humans.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| [Intel framework](https://github.com/intel/idlf) ⚠️ Archived                                                                                    | Intel® Deep Learning Framework                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| [Datawrapper](https://www.datawrapper.de/)                                                                                                      | An open source data visualization platform helping everyone to create simple, correct and embeddable charts. Also at [github.com](https://github.com/datawrapper/datawrapper) ⭐ 1,458 \| 🐛 75 \| 🌐 TypeScript \| 📅 2025-03-30                                                                                                                                                                                                                                                                                                                                                                              |
...
| [FunASR](https://github.com/modelscope/FunASR) ⭐ 20,491 \| 🐛 34 \| 🌐 Python \| 📅 2026-09-24                                                  | Industrial-grade speech recognition toolkit supporting 50+ languages with built-in VAD, punctuation, speaker diarization, and emotion detection. OpenAI-compatible API server included.                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
| [IJulia](https://github.com/JuliaLang/IJulia.jl) ⭐ 2,906 \| 🐛 36 \| 🌐 Julia \| 📅 2026-06-23                                                  | a Julia-language backend combined with the Jupyter interactive environment                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
| [Featuretools](https://github.com/alteryx/featuretools) ⭐ 7,684 \| 🐛 171 \| 🌐 Python \| 📅 2026-09-11                                         | An open source framework for automated feature engineering written in python                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| [Optimus](https://github.com/hi-primus/optimus) ⭐ 1,536 \| 🐛 30 \| 🌐 Python \| 📅 2024-12-02                                                  | Cleansing, pre-processing, feature engineering, exploratory data analysis and easy ML with PySpark backend.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| [DVC](https://github.com/iterative/dvc) ⭐ 15,885 \| 🐛 213 \| 🌐 Python \| 📅 2026-09-21                                                        | An open-source data science version control system. It helps track, organize and make data science projects reproducible. In its very basic scenario it helps version control and share large data and model files.                                                                                                                                                                                                                                                                                                                                                                                           |
| [Lambdo](https://github.com/asavinov/lambdo) ⭐ 26 \| 🐛 0 \| 🌐 Python \| 📅 2021-01-01                                                         | is a workflow engine that significantly simplifies data analysis by combining in one analysis pipeline (i) feature engineering and machine learning (ii) model training and prediction (iii) table population and column evaluation.                                                                                                                                                                                                                                                                                                                                                                          |
| [Feast](https://github.com/feast-dev/feast) ⭐ 7,306 \| 🐛 443 \| 🌐 Python \| 📅 2026-09-23                                                     | A feature store for the management, discovery, and access of machine learning features. Feast provides a consistent view of feature data for both model training and model serving.                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| [Trains](https://github.com/allegroai/clearml) ⭐ 6,888 \| 🐛 525 \| 🌐 Python \| 📅 2026-09-23                                                  | Auto-Magical Experiment Manager, Version Control & DevOps for AI                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| [Hopsworks](https://github.com/logicalclocks/hopsworks) ⭐ 1,307 \| 🐛 16 \| 🌐 Java \| 📅 2025-02-10                                            | Open-source data-intensive machine learning platform with a feature store. Ingest and manage features for both online (MySQL Cluster)  and offline (Apache Hive) access, train and serve models at scale.                                                                                                                                                                                                                                                                                                                                                                                                     |
| [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 39,764 \| 🐛 6 \| 🌐 Makefile \| 📅 2026-09-16                                                  | MindsDB is an Explainable AutoML framework for developers. With MindsDB you can build, train and use state of the art ML models in as simple as one line of code.                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| [Lightwood](https://github.com/mindsdb/lightwood) ⭐ 510 \| 🐛 17 \| 🌐 Python \| 📅 2026-08-28                                                  | A Pytorch based framework that breaks down machine learning problems into smaller blocks that can be glued together seamlessly with an objective to build predictive models with one line of code.                                                                                                                                                                                                                                                                                                                                                                                                            |
| [AWS Data Wrangler](https://github.com/awslabs/aws-data-wrangler) ⭐ 4,119 \| 🐛 57 \| 🌐 Python \| 📅 2026-09-22                                | An open-source Python package that extends the power of Pandas library to AWS connecting DataFrames and AWS data related services (Amazon Redshift, AWS Glue, Amazon Athena, Amazon EMR, etc).                                                                                                                                                                                                                                                                                                                                                                                                                |
...
| [CML](https://github.com/iterative/cml) ⭐ 4,187 \| 🐛 86 \| 🌐 JavaScript \| 📅 2025-06-02                                                      | An open source toolkit for using continuous integration in data science projects. Automatically train and test models in production-like environments with GitHub Actions & GitLab CI, and autogenerate visual reports on pull/merge requests.                                                                                                                                                                                                                                                                                                                                                                |
...
| [DuckDB](https://github.com/duckdb/duckdb) ⭐ 41,682 \| 🐛 921 \| 🌐 C++ \| 📅 2026-09-24                                                        | An in-process SQL OLAP database management system                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
| [Grid Studio](https://github.com/ricklamers/gridstudio) ⚠️ Archived                                                                             | Grid studio is a web-based spreadsheet application with full integration of the Python programming language.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| [Python Data Science Handbook](https://github.com/jakevdp/PythonDataScienceHandbook) ⭐ 49,986 \| 🐛 226 \| 🌐 Jupyter Notebook \| 📅 2024-06-26 | Python Data Science Handbook: full text in Jupyter Notebooks                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
| [Towhee](https://github.com/towhee-io/towhee) ⭐ 3,451 \| 🐛 0 \| 🌐 Python \| 📅 2024-10-18                                                     | A Python library that helps you encode your unstructured data into embeddings.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| [LineaPy](https://github.com/LineaLabs/lineapy) ⭐ 672 \| 🐛 51 \| 🌐 Jupyter Notebook \| 📅 2025-02-22                                          | Ever been frustrated with cleaning up long, messy Jupyter notebooks? With LineaPy, an open source Python library, it takes as little as two lines of code to transform messy development code into production pipelines.                                                                                                                                                                                                                                                                                                                                                                                      |
...
| [cleanlab](https://github.com/cleanlab/cleanlab) ⭐ 11,671 \| 🐛 124 \| 🌐 Python \| 📅 2026-01-13                                               | Python library for data-centric AI and automatically detecting various issues in ML datasets                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| [AutoGluon](https://github.com/awslabs/autogluon) ⭐ 10,745 \| 🐛 384 \| 🌐 Python \| 📅 2026-09-24                                              | AutoML to easily produce accurate predictions for image, text, tabular, time-series, and multi-modal data                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
| [Comet](https://github.com/comet-ml/comet-examples) ⭐ 176 \| 🐛 27 \| 🌐 Jupyter Notebook \| 📅 2026-08-12                                      | An MLOps platform with experiment tracking, model production management, a model registry, and full data lineage to support your ML workflow from training straight through to production.                                                                                                                                                                                                                                                                                                                                                                                                                    |
| [Opik](https://github.com/comet-ml/opik) ⭐ 22,212 \| 🐛 249 \| 🌐 Python \| 📅 2026-09-24                                                       | Evaluate, test, and ship LLM applications across your dev and production lifecycles.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
| [teeplot](https://github.com/mmore500/teeplot) ⭐ 13 \| 🐛 1 \| 🌐 Python \| 📅 2026-04-21                                                       | Workflow tool to automatically organize data visualization output                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| [Streamlit](https://github.com/streamlit/streamlit) ⭐ 45,827 \| 🐛 1,182 \| 🌐 Python \| 📅 2026-09-24                                          | App framework for Machine Learning and Data Science projects                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| [Gradio](https://github.com/gradio-app/gradio) ⭐ 43,612 \| 🐛 105 \| 🌐 Python \| 📅 2026-09-23                                                 | Create customizable UI components around machine learning models                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| [Weights & Biases](https://github.com/wandb/wandb) ⭐ 11,261 \| 🐛 987 \| 🌐 Python \| 📅 2026-09-24                                             | Experiment tracking, dataset versioning, and model management                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| [DVC](https://github.com/iterative/dvc) ⭐ 15,885 \| 🐛 213 \| 🌐 Python \| 📅 2026-09-21                                                        | Open-source version control system for machine learning projects                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| [Optuna](https://github.com/optuna/optuna) ⭐ 14,843 \| 🐛 23 \| 🌐 Python \| 📅 2026-09-22                                                      | Automatic hyperparameter optimization software framework                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| [Ray Tune](https://github.com/ray-project/ray) ⭐ 43,913 \| 🐛 3,616 \| 🌐 Python \| 📅 2026-09-24                                               | Scalable hyperparameter tuning library                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| [Apache Airflow](https://github.com/apache/airflow) ⭐ 46,957 \| 🐛 2,077 \| 🌐 Python \| 📅 2026-09-24                                          | Platform to programmatically author, schedule, and monitor workflows                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| [Prefect](https://github.com/PrefectHQ/prefect) ⭐ 23,915 \| 🐛 853 \| 🌐 Python \| 📅 2026-09-24                                                | Workflow management system for modern data stacks                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| [Kedro](https://github.com/kedro-org/kedro) ⭐ 11,008 \| 🐛 133 \| 🌐 Python \| 📅 2026-09-24                                                    | Open-source Python framework for creating reproducible, maintainable data science code                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| [Hamilton](https://github.com/dagworks-inc/hamilton) ⭐ 2,599 \| 🐛 176 \| 🌐 Jupyter Notebook \| 📅 2026-09-24                                  | Lightweight library to author and manage reliable data transformations                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| [SHAP](https://github.com/slundberg/shap) ⭐ 25,780 \| 🐛 983 \| 🌐 Jupyter Notebook \| 📅 2026-09-21                                            | Game theoretic approach to explain the output of any machine learning model                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| [LIME](https://github.com/marcotcr/lime) ⭐ 12,162 \| 🐛 133 \| 🌐 JavaScript \| 📅 2024-07-25                                                   | Explaining the predictions of any machine learning classifier                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| [flyte](https://github.com/flyteorg/flyte) ⭐ 7,558 \| 🐛 179 \| 🌐 Go \| 📅 2026-09-24                                                          | Workflow automation platform for machine learning                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| [dbt](https://github.com/dbt-labs/dbt-core) ⭐ 13,918 \| 🐛 1,587 \| 🌐 Rust \| 📅 2026-09-24                                                    | Data build tool                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| [zasper](https://github.com/zasper-io/zasper) ⭐ 2,343 \| 🐛 3 \| 🌐 TypeScript \| 📅 2026-09-23                                                 | Supercharged IDE for Data Science                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| [skrub](https://github.com/skrub-data/skrub/) ⭐ 1,653 \| 🐛 135 \| 🌐 Python \| 📅 2026-09-24                                                   | A Python library to ease preprocessing and feature engineering for tabular machine learning                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| [Chinese-Elite](https://github.com/anonym-g/Chinese-Elite) ⭐ 73 \| 🐛 1 \| 🌐 Python \| 📅 2026-06-10                                           | An open-source project that automatically maps relationship networks by parsing public data using LLMs and visualizes it as an interactive graph.                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| [Desbordante](https://github.com/desbordante/desbordante-core/) ⭐ 506 \| 🐛 90 \| 🌐 C++ \| 📅 2026-09-23                                       | An open-source data profiler specifically focused on discovery and validation of complex patterns, such as [numerical association rules](https://colab.research.google.com/github/Desbordante/desbordante-core/blob/main/examples/notebooks/Numerical_Association_Rules.ipynb), [differential dependencies](https://colab.research.google.com/github/Desbordante/desbordante-core/blob/main/examples/notebooks/Differential_Dependencies.ipynb), [denial constraints](https://colab.research.google.com/github/Desbordante/desbordante-core/blob/main/examples/notebooks/Denial_Constraints.ipynb), and more. |
...
| [RunMat](https://github.com/runmat-org/runmat) ⭐ 257 \| 🐛 25 \| 🌐 Rust \| 📅 2026-09-21                                                       | Fast MATLAB-syntax runtime with automatic CPU/GPU execution and fused array kernels.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| [Turbostream](https://github.com/turboline-ai/turbostream) ⭐ 17 \| 🐛 0 \| 🌐 Go \| 📅 2026-02-23                                               | A terminal UI for experimenting with custom rule engines and selective LLM analysis on real-time data streams, without worrying about streaming infra or backpressure.                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| [WFGY ProblemMap](https://github.com/onestardao/WFGY/blob/main/ProblemMap/README.md) ⭐ 1,794 \| 🐛 13 \| 🌐 Jupyter Notebook \| 📅 2026-09-24   | Open source “failure atlas” of 16 recurring issues in LLM and RAG pipelines, with observable symptoms and suggested fixes for data science teams.                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| [Deploybase](https://deploybase.ai/)                                                                                                            | Track real-time GPU and LLM pricing across all cloud and inference providers.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| [DeepAnalyze](https://github.com/ruc-datalab/DeepAnalyze) ⭐ 4,649 \| 🐛 25 \| 🌐 Python \| 📅 2026-09-23                                        | An agentic LLM for autonomous data science, which can autonomously complete a wide range of data science tasks without human intervention.                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| [Disco](https://github.com/leap-laboratories/discovery-engine) ⭐ 7 \| 🐛 1 \| 🌐 Python \| 📅 2026-09-10                                        | Superhuman exploratory data analysis. Finds the feature interactions and subgroup effects in tabular data that LLMs and manual exploration miss — with p-values, effect sizes, and literature citations. Free for public data.                                                                                                                                                                                                                                                                                                                                                                                |
...
| [Crypto Pump Scanner](https://github.com/stefanoviana/deepalpha) ⭐ 46 \| 🐛 17 \| 🌐 Python \| 📅 2026-05-12                                    | AI-powered cryptocurrency trading bot with LSTM neural network (84.6% accuracy). Real-time pump detection, walk-forward validated models, multi-exchange support (Bybit, Binance, OKX, Gate.io). Open source.                                                                                                                                                                                                                                                                                                                                                                                                 |
| [Future AGI](https://github.com/future-agi/future-agi) ⭐ 2,064 \| 🐛 1,038 \| 🌐 Python \| 📅 2026-09-24                                        | Open-source platform to simulate, evaluate, trace, guardrail, route, and optimize LLM and AI agent apps in one feedback loop, so agents don't just get monitored, they self-improve. Self-hostable. Apache-2.0.                                                                                                                                                                                                                                                                                                                                                                                               |
...
* [How to Share Data with a Statistician](https://github.com/jtleek/datasharing) ⭐ 6,763 | 🐛 913 | 📅 2024-08-07
...
* [Covid-19](https://github.com/datasets/covid-19) ⭐ 1,166 | 🐛 34 | 🌐 Python | 📅 2026-03-24
* [Open Data Sources](https://github.com/datasciencemasters/data) ⭐ 523 | 🐛 4 | 📅 2018-05-08
* [Public Git Archive](https://github.com/src-d/datasets/tree/master/PublicGitArchive) ⭐ 349 | 🐛 26 | 🌐 Jupyter Notebook | 📅 2019-11-27
* [FirstData](https://github.com/MLT-OSS/FirstData) ⭐ 183 | 🐛 2 | 🌐 Python | 📅 2026-08-17 - The world's most comprehensive authoritative data source knowledge base. 210+ curated sources from governments, international organizations, and research institutions. MCP integration for AI agents. MIT licensed.
* [5000 Images of Clothes](https://github.com/alexeygrigorev/clothing-dataset) ⭐ 119 | 🐛 3 | 📅 2021-01-17
* [Covid-19 Google](https://github.com/google-research/open-covid-19-data) ⚠️ Archived
* [ZipCheckup](https://github.com/artakulov/us-water-quality-data) ⭐ 4 | 🐛 0 | 📅 2026-09-16 - Free ZIP-level environmental safety data for 42,000+ US ZIP codes: water quality, air quality, PFAS contamination, radon, lead, flood risk, and 11 more verticals. Public REST API, npm/PyPI packages, CC BY 4.0.
* [NAYN.CO Turkish News with categories](https://github.com/naynco/nayn.data) ⭐ 3 | 🐛 0 | 📅 2019-10-15
* [BDE Score](https://github.com/hbhqq9/bde-score) ⭐ 3 | 🐛 1 | 🌐 Python | 📅 2026-08-01 - AI-powered multi-market stock analysis with transparent BDE scoring across 73 stocks (US/HK/A-share). EU AI Act Art.50 compliant. MIT license.
* [Verified Supplement Evidence](https://github.com/erinheit451/verified-supplement-evidence) ⭐ 3 | 🐛 0 | 🌐 HTML | 📅 2026-07-04 - Evidence-graded dietary-supplement dataset covering dosing, bioavailability by form, drug-nutrient interactions, NHANES deficiency prevalence, FDA FAERS adverse-event signals, and cost-per-effective-dose, with every clinical claim citing a PubMed PMID. CC BY 4.0, DOI 10.57967/hf/9356.
* [US Truck-Involved Fatal Crashes (FARS) 2018-2024](https://doi.org/10.5281/zenodo.20487070) - Filtered subset of NHTSA Fatality Analysis Reporting System covering 33,898 fatal crashes involving medium and heavy commercial trucks across all 50 US states, 2018-2024. Includes interactive [Vision Zero Report Card](https://accidentlawyerreview.com/research/vision-zero-report-card/) comparing 19 cities, reproducible Python pipeline on [GitHub](https://github.com/MarvinBregiosa/vision-zero-fars) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2026-06-01, and HuggingFace mirror. Permanent DOI, CC BY 4.0.
* [latamdata-py](https://github.com/juanmoisesd/latamdata-py) ⭐ 2 | 🐛 3 | 🌐 Python | 📅 2026-09-15 - Python package for one-line access to 38 open research datasets from Latin America (health, neuroscience, mental health, economics). pip install latamdata-py.
* [College ROI Dataset](https://github.com/thomasthinks/college-roi-data) ⭐ 0 | 🐛 0 | 📅 2026-08-13 - Lifetime return-on-investment estimates for \~30K US bachelor's programs across 1,775 institutions, built from FREOPP, IPEDS, and BEA regional price data. 5 CSVs with data dictionary, CC BY 4.0, Zenodo DOI.
* [Pokemon Card Centering Measurements](https://github.com/rrh1441/pokemon-card-centering-measurements) ⭐ 0 | 🐛 0 | 📅 2026-09-12 - 320 measured PSA-style centering annotations (left/right and top/bottom border percentages, tilt) across 302 real eBay-listed Pokemon cards. CSV, CC BY 4.0, Zenodo DOI.
* [Pokemon Card Sold-Price Reference by Grade](https://github.com/rrh1441/pokemon-card-sold-price-reference) ⭐ 0 | 🐛 0 | 📅 2026-09-12 - Median sold price by grade (raw, PSA 9, PSA 10) for 486 Pokemon cards, with sample size and confidence flag per card. CSV, CC BY 4.0, Zenodo DOI.
* [HDD Price Index](https://github.com/AdamDudley/hddhunt-price-index) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-09-22 - Daily open dataset of the cheapest new internal 3.5" SATA hard-drive price per terabyte (USD/TB) by capacity tier on Amazon US, with a historical time series. CSV, JSON and JSONL, no login, CC BY 4.0.
* [WhatFontIs-Bench](https://github.com/whatfontis/WhatFontIs-Bench) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-09-21 - Synthetic benchmark for font family identification with 11,995 images of words set in 600 known fonts, annotated with word and per-letter boxes.
...
* [awesome-python](https://github.com/vinta/awesome-python) ⭐ 322,657 | 🐛 22 | 🌐 Python | 📅 2026-09-23
* [awesome-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 79,133 | 🐛 161 | 📅 2026-09-23
* [Awesome Machine Learning](https://github.com/josephmisiti/awesome-machine-learning) ⭐ 74,436 | 🐛 20 | 🌐 Python | 📅 2026-09-22
* Other amazingly awesome lists can be found in the [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,685 | 🐛 66 | 🌐 Ruby | 📅 2024-06-02
...
* [awesome-Machine Learning & Deep Learning Tutorials](https://github.com/ujjwalkarn/Machine-Learning-Tutorials/blob/master/README.md) ⭐ 18,222 | 🐛 49 | 📅 2024-06-12
* [lists](https://github.com/jnv/lists) ⭐ 11,507 | 🐛 30 | 📅 2026-03-23
* [Data Science Interviews Questions](https://github.com/alexeygrigorev/data-science-interviews) ⭐ 10,157 | 🐛 7 | 🌐 HTML | 📅 2026-08-18
...
* [awesome-dataviz](https://github.com/javierluraschi/awesome-dataviz) ⭐ 4,415 | 🐛 45 | 📅 2024-01-26
* [100 NLP Papers](https://github.com/mhagiwara/100-nlp-papers) ⭐ 3,852 | 🐛 2 | 📅 2021-07-09
* [Data Science Projects](https://github.com/veb-101/Data-Science-Projects) ⭐ 2,789 | 🐛 10 | 🌐 Jupyter Notebook | 📅 2023-11-11
...
* [Awesome Data Analysis](https://github.com/PavelGrigoryevDS/awesome-data-analysis) ⭐ 1,980 | 🐛 12 | 📅 2026-08-09 -  A curated list of data analysis tools, libraries and resources.
* [Awesome Fraud Detection Papers](https://github.com/benedekrozemberczki/awesome-fraud-detection-papers) ⭐ 1,835 | 🐛 2 | 🌐 Python | 📅 2026-01-05
* [Awesome Game Datasets](https://github.com/leomaurodesenv/game-datasets#readme) ⭐ 1,128 | 🐛 2 | 📅 2026-09-21
* [Awesome Gradient Boosting Papers](https://github.com/benedekrozemberczki/awesome-gradient-boosting-papers) ⭐ 1,051 | 🐛 3 | 🌐 Python | 📅 2026-01-05
* [Awesome Monte Carlo Tree Search](https://github.com/benedekrozemberczki/awesome-monte-carlo-tree-search-papers) ⭐ 715 | 🐛 0 | 🌐 Python | 📅 2026-01-13
* [Awesome Data Science Ideas](https://github.com/JosPolfliet/awesome-ai-usecases) ⚠️ Archived
* [Awesome Computer Vision Models](https://github.com/nerox8664/awesome-computer-vision-models) ⭐ 543 | 🐛 0 | 📅 2021-05-09
* [Awesome Drug Synergy, Interaction and Polypharmacy Prediction](https://github.com/AstraZeneca/awesome-drug-pair-scoring) ⭐ 101 | 🐛 0 | 📅 2022-08-07
* [Awesome Evidence Synthesis](https://github.com/evidencesynthesis-tools/awesome-evidence-synthesis) ⭐ 27 | 🐛 1 | 📅 2026-08-26 - A curated list of open-source tools for systematic reviews, meta-analysis, and evidence synthesis.
* [ML/AI Interview Prep](https://github.com/aasimansari1/ml-interview-prep) ⭐ 2 | 🐛 3 | 📅 2026-05-18 - 500+ ML/AI interview Q\&A with runnable code — covers ML fundamentals, deep learning, NLP, PyTorch, scikit-learn pipelines, and system design
...
* [Awesome Music Production](https://github.com/ad-si/awesome-music-production) ⭐ 1,505 | 🐛 41 | 📅 2026-09-23
